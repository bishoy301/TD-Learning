...
Move nextMove();
WM memoryUpdate(const DFTTool& tool, HRR current_memory, HRR current_signal, HRR nothing_state, HRR current_location_HRR, HRR current_signal);
